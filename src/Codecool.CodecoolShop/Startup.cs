...
namespace Codecool.CodecoolShop
{
    public class Startup
    {
        ...
        private void SetupInMemoryDatabases()
        {
            ...
            IProductDao productDataStore;
            IProductCategoryDao productCategoryDataStore;
            ISupplierDao supplierDataStore;
            SqlManager sqlManager = SqlManager.GetInstance();
            if (!sqlManager.testConnection())
            {
                productDataStore = ProductDaoMemory.GetInstance();
                productCategoryDataStore = ProductCategoryDaoMemory.GetInstance();
                supplierDataStore = SupplierDaoMemory.GetInstance();
...
Helping to take L4D's frantic, action-packed gameplay to the next level is AI Director 2.0. This improved Director has the ability to procedurally change the weather you'll fight through and the pathways you'll take, in addition to tailoring the enemy population, effects, and sounds to match your performance. L4D2 promises a satisfying and uniquely challenging experience every time the game is played, custom-fitted to your style of play." });
                ...
                productDataStore.Add(new Product()
                {
                    ...
                    Supplier = valve,
                    imgURL = "https://cdn.akamai.steamstatic.com/steam/apps/400/header.jpg?t=1608593358",
                    Description =
...
//                const string cleanupCmd =
//                    "delete from cart_order; delete from users; update product_categories set featured_elem = Null; delete from products; delete from product_categories;delete from suppliers;";
//                try
//                {
//                    using (var connection = new SqlConnection(ConfigurationManager.AppSettings["connectionString"]))
//                    {
//                        var cmd = new SqlCommand(cleanupCmd, connection);
...
//                var eldenRing = productDataStore.GetBy("ELDEN RING");
//                productCategoryDataStore.SetFeatured(RPG.Id, eldenRing.Id);
//                var ror2 = productDataStore.GetBy("Risk of Rain 2");
//                productCategoryDataStore.SetFeatured(rogueLike.Id, ror2.Id);
//                var cs = productDataStore.GetBy("Counter-Strike: Global Offensive");
//                productCategoryDataStore.SetFeatured(shooter.Id, cs.Id);
//                var portal2 = productDataStore.GetBy("Portal 2");
//                productCategoryDataStore.SetFeatured(puzzle.Id, portal2.Id);
            }
